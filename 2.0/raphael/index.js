;KISSY.add("gallery/kcharts/2.0/raphael/index",function(S){
  ...
  (function(glob, factory) {
    ...
    (function() {
      ...
      R._engine.create = function() {
        ...
        //modified by kcharts team
        cs.cssText = R.format("top:auto;left:auto;width:{0};height:{1};display:inline-block;position:absolute;clip:rect(0 {0} {1} 0);overflow:hidden", width, height);
        if (container == 1) {
